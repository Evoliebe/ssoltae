			...
			<table class="table table-bordered">
	  		...
	  		<c:forEach var="communityDataList" items="${communityDataList}">
	  			<tr>
			        ...
			        <td>${communityDataList.boardArticleDate}</td>
			        <td>${communityDataList.boardArticleWriter}</td>
			        <td>${communityDataList.boardArticleReadCount}</td>
			     </tr>
	  		</c:forEach>
		  	</table>
				...
				<div class="row">
					<div class="col-sm-4 col-sm-offset-2">
						<div id="imaginary_container"> 
							<form action="/smedu/community/communityDataList">
